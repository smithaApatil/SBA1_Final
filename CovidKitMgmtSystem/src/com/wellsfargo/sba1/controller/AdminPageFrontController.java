...
@WebServlet({"/list","/newProdForm","/addProd","/editProd","/updateProd","/deleteProd", "/admin","/login","/logout"})
//@WebServlet("/AdminPageFrontController")
   ...
   private ProductService prodService;
	...
	private String adminLogout(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        try {
	        ...
	        session.invalidate();  
	        request.setAttribute("msg", "Admin logged successfully ");
	        view = "index.jsp";
		} catch (Exception e) {
			e.printStackTrace();
	...
	private String adminLogin(HttpServletRequest request, HttpServletResponse response) {
		...
		try {
			...
			{
				request.setAttribute("errMsg", "Invalid cridentials . Please check your user name or password!!");
