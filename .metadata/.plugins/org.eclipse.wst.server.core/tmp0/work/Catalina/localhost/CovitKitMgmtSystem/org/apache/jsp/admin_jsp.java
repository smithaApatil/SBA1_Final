 ...
 * Generated at: 2020-11-08 19:16:04 UTC
...
public final class admin_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	if (session.getAttribute("message") == null || session.getAttribute("message").toString().isEmpty() || session.getAttribute("message")!="admin") {
      ...
      out.write("\n");
      out.write("\t\t<div>\n");
      out.write("\t\t\t<div><label for=\"loginid\">Enter LoginID : </label> </div>\n");
      out.write("\t\t\t<div><input type=\"text\" id=\"loginid\" name=\"loginid\"> </div>\n");
      out.write("\t\t</div>\n");
      out.write("\t\t<div>\n");
      out.write("\t\t\t<div><label for=\"password\">Enter password : </label> </div>\n");
      out.write("\t\t\t<div><input type=\"text\" id=\"password\" name=\"password\"> </div>\n");
      out.write("\t\t</div>\n");
      out.write("\t\t<div>\n");
